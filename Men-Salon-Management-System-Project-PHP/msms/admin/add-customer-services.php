...
echo '<script>alert("Tạo hóa đơn thành công. Số hóa đơn là "+"'.$invoiceid.'")</script>';
...
<head>
    <title>PDT181Admin || Thêm dịch vụ cho khách hàng</title>
            ...
            <div class="main-page">
                <div class="tables">
                    ...
                    <div class="table-responsive bs-example widget-shadow">
                        <h4>Thêm dịch vụ cho khách hàng:</h4>
                        <form method="post">
