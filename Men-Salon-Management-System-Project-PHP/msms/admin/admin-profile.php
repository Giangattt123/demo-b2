...
if (strlen($_SESSION['bpmsaid']==0)) {
  ...
  $mobno=$_POST['contactnumber'];
    ...
    echo '<script>alert("Hồ sơ Admin cập nhật thành công")</script>';
  }
  else
    {
...
<head>
    <title>PDT181Admin | Hồ sơ Admin</title>
...
?>
                                <div class="form-group"> <label for="exampleInputEmail1">Tên</label> <input
                                        type="text" class="form-control" id="adminname" name="adminname"
                                        placeholder="Nhập tên admin" value="<?php  echo $row['AdminName'];?>"> </div>
                                <div class="form-group"> <label for="exampleInputPassword1">Tên đăng nhập</label> <input
