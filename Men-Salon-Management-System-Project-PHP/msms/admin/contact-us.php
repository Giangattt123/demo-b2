...
$timing=$_POST['timing'];
    ...
    echo '<script>alert("Trang liên hệ đã được cập nhật!")</script>';
  }
  else
    {
...
<head>
    <title>PDT181Admin | Trang liên hệ</title>
...
<body class="cbp-spmenu-push">
    <div class="main-content">
        ...
        <div id="page-wrapper">
            <div class="main-page">
                <div class="forms">
                    <h3 class="title1">Cập Nhật Trang Liên Hệ</h3>
                    <div class="form-grids row widget-shadow" data-example-id="basic-forms">
                        <div class="form-title">
                            <h4>Nhập thông tin liên hệ mới:</h4>
                        </div>
                        <div class="form-body">
                            <form method="post">
...
?>
                                ...
                                <div class="form-group"> <label for="exampleInputEmail1">Tiêu đề</label> <input
                                ...
                                <div class="form-group"> <label for="exampleInputEmail1">Thời gian làm việc</label> <input
