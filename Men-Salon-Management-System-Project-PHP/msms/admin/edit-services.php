...
<head>
    <title>PDT181Admin | Cập nhật dịch vụ</title>
                ...
                <div class="forms">
                    ...
                    <div class="form-grids row widget-shadow" data-example-id="basic-forms">
                        <div class="form-title">
                            <h4>Cập nhật thông tin mới cho dịch vụ:</h4>
                        </div>
                        <div class="form-body">
                            <form method="post">
...
?>
                                ...
                                <div class="form-group"> <label for="exampleInputEmail1">Tên dịch vụ</label> <input
                                        ...
                                        placeholder="Nhập tên dịch vụ" value="<?php  echo $row['ServiceName'];?>"
                                        required="true"> </div>
                                ...
                                <div class="form-group"> <label for="exampleInputPassword1">Giá</label> <input
                                        type="text" id="cost" name="cost" class="form-control" placeholder="Nhập giá dịch vụ"
