      ...
      <div class="navbar-collapse">
          <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
              <ul class="nav" id="leftCol" style="margin-top:7% ;">
                  <li>
                      <a href="dashboard.php"><i class="fa fa-home nav_icon"></i>Trang chủ</a>
                  </li>
                  <li>
                      <a href="add-services.php"><i class="fa fa-cogs nav_icon"></i>Dịch vụ<span
                  ...
                  <li>
                      <a href="all-appointment.php"><i class="fa fa-check-square-o nav_icon"></i>Lịch hẹn<span
                              class="fa arrow"></span></a>
                      <ul class="nav nav-second-level collapse">
                          <li>
                              <a href="all-appointment.php">Tất cả lịch hẹn</a>
                          </li>
                          <li>
                              <a href="new-appointment.php">Lịch hẹn mới</a>
                          </li>
                          <li>
                              <a href="accepted-appointment.php">Lịch hẹn đã xác nhận</a>
                          </li>
                          <li>
                  ...
                  <li>
                      <a href="subcriber.php" class="chart-nav"><i class="fa fa-user nav_icon"></i>Người đăng ký</a>
                  </li>

                  <li>
                      <a href="add-customer.php" class="chart-nav"><i class="fa fa-user nav_icon"></i>Thêm khách hàng</a>
                  </li>
                  <li>
                  ...
                  <!-- <li>
                      <a href="bwdates-reports-ds.php" class="chart-nav"><i class="fa fa-file-text-o nav_icon"></i>B/W
                          Dates Report</a>
                  </li> -->
                  <li>
                      <a href="sales-reports.php" class="chart-nav"><i class="fa fa-file-text-o nav_icon"></i>Báo cáo doanh thu</a>
                  </li>
                  <li>
