...
<head>
    <title>PDT181Admin || Tìm kiếm lịch hẹn</title>
...
<body class="cbp-spmenu-push">
            ...
            <div class="main-page">
                <div class="tables">
                    ...
                    <div class="table-responsive bs-example widget-shadow">
                        <h4>Tìm kiếm lịch hẹn / tên / số điện thoại:</h4>
                        <div class="form-body">
    ...
    echo $msg;
                                ...
                                <div class="form-group"> <label for="exampleInputEmail1">Tìm kiếm theo số lịch hẹn /
                                        Tên / Số điện thoại </label> <input id="searchdata" type="text"
