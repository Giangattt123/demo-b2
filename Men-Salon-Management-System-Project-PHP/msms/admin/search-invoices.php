...
<head>
    <title>PDT181 || Tìm kiếm hóa đơn</title>
...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
                                ...
                                <div class="form-group"> <label for="exampleInputEmail1">Tìm kiếm theo số hóa đơn hoặc tên khách hàng

								</label> <input id="searchdata" type="text"
...
$sdata=$_POST['searchdata'];
  ?>
                        <h4 align="center">Kết quả trả về cho "<?php echo $sdata;?>" từ khóa </h4>
...
?>
                                ...
                                <tr>
                                    ...
                                    <td><a href="view-invoice.php?invoiceid=<?php  echo $row['BillingId'];?>">Xem</a>
                                    </td>
