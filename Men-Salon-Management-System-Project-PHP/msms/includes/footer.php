...
?>
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                        <div class="footer-widget widget-newsletter">
                            <!-- newsletter block -->
                            <h2 class="widget-title">Đăng ký ngay</h2>
                            <p>Nhập Email của bạn để nhận ngay những thông tin mới nhất từ dịch vụ của chúng tôi.</p>
                            <form method="post">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Nhập Email của bạn" name="email">
                                <span class="input-group-btn">
                            <button class="btn btn-default" type="submit" value="submit" name="sub">Đăng ký</button>
                            </span>
                            </div></form>
                            <!-- /input-group -->
                        </div>
