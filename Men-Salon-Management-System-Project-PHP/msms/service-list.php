...
<head>
    ...
    <title>PDT181Salon || Danh Sách Dịch Vụ</title>
    <!-- Bootstrap -->
   ...
   <?php include_once('includes/header.php');?>
    ...
    <div class="content">
        <div class="container">
            ...
            <p>Chúng tôi cung cấp bảng giá tốt nhất cho từng dịch vụ</p>
          </div>
               <table class="table table-bordered"> <thead> <tr> <th>TT</th> <th></th> <th>Giá</th> <th>Mô tả</th> </tr> </thead> <tbody>
<?php
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-sm-7 col-md-8 col-xs-12">
                    <h1 class="cta-title">Đặt lịch online ngay</h1>
                    <p class="cta-text">Click ngay để đặt lịch.</p>
                </div>
                <div class="col-lg-4 col-sm-5 col-md-4 col-xs-12">
                    <a href="appointment.php" class="btn btn-white btn-lg mt20">Đặt lịch ngay</a>
                </div>
            </div>
        </div>
    </div>
